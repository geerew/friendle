...
var (
	...
	ErrGroupNameRequired   = errors.New("name required")
	ErrGroupNameTaken      = errors.New("group name already exists")
	ErrAlreadyGroupMember  = errors.New("already a member")
	ErrJoinRequestNotFound = errors.New("pending request not found")
	ErrCannotJoinGroup     = errors.New("unable to join this group")
