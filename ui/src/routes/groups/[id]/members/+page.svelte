				...
				{#each members as member, index (member.userId)}
					<Table.Row label={member.displayName}>
						{#snippet trailing()}
							...
							<button
								type="button"
								class="text-foreground-alt-2 hover:bg-background-alt-1 hover:text-foreground focus-visible:ring-background-primary flex size-5 shrink-0 items-center justify-center rounded-md transition-colors focus-visible:ring-2 focus-visible:outline-none"
